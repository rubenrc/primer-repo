    ...
    <body>
        ...
        <%
                ...
                try {
                    ...
                    conection=DriverManager.getConnection("jdbc:mysql://localhost/siec", "root","root");
                ...
                String path = "c://Users/Ruben/Downloads/garrisonx-Proyecto-SIEC-bdbf755/garrisonx-Proyecto-SIEC-bdbf755/web/Reporte de competencias"; // ruta donde esta el jasper dentro de tu proyecto
      ...
      <tr class="general">
        ...
        <td class="general" align="center">
            <a href="<%=xUtil.getContexto(request)%>/ReporteCompetencias.zip" target="_self">
                <img  src="imgPDF.gif" border="0" style="cursor:hand" name="imgPdf"></a>
