	...
	private boolean proceso(String taskName) {
		...
		try	{
		    ...
		    JasperExportManager.exportReportToPdfFile(source+ ".jrprint", target+ ".pdf");
				if(debug)
  		    System.out.println("PDF-Tiempo de creación: " + (System.currentTimeMillis() - start));
	    }
	    else
			if (TASK_XML.equals(taskName)) {
	      JasperExportManager.exportReportToXmlFile(source+ ".jrprint", target+ ".xml", false);
				if(debug)
  	      System.out.println("XML-Tiempo de creación: " + (System.currentTimeMillis() - start));
	    }
	    else
	    if (TASK_XML_EMBED.equals(taskName)) {
			...
			if (TASK_HTML.equals(taskName))	{
			  JasperExportManager.exportReportToHtmlFile(source+ ".jrprint", target+ ".html");
				if(debug)
  			  System.out.println("HTML-Tiempo de creación: " + (System.currentTimeMillis() - start));
			}
			else
        ...
        exporter.exportReport();
				if(debug)
  				System.out.println("XLS-Tiempo de creación: " + (System.currentTimeMillis() - start));
			}
			else
			if (TASK_CSV.equals(taskName))	{
				...
				exporter.exportReport();
				if(debug)
  				System.out.println("CSV-Tiempo de creación: " + (System.currentTimeMillis() - start));
			}
			else
